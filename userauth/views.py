...
from prof.models import WorkExperience, Education, SocialProfile

from prof.serializers import WorkExperienceSerializer, EducationSerializer, SocialProfileSerializer
